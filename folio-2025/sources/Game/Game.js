...
export class Game
{
    ...
    async init()
    {
        ...
        if(window.parent && window.parent !== window)
            document.documentElement.classList.add('zuoyizhuo-embed')
        ...
        const resourcesPromise = this.resourcesLoader.load(
            [
                ...
                [ 'vehicle',                               `vehicle/Vehicle_SUV.glb${cb}`,                                                       'gltf' ],
                ...
                [ 'zuoyizhuoAsphaltColor',                 `zuoyizhuo/ground/asphalt-color.jpg`,                                              'texture', (resource) => { resource.wrapS = THREE.RepeatWrapping; resource.wrapT = THREE.RepeatWrapping; resource.colorSpace = THREE.SRGBColorSpace; resource.minFilter = THREE.LinearMipmapLinearFilter; resource.magFilter = THREE.LinearFilter; resource.generateMipmaps = true } ],
                [ 'zuoyizhuoAsphaltNormal',                `zuoyizhuo/ground/asphalt-normal.jpg`,                                             'texture', (resource) => { resource.wrapS = THREE.RepeatWrapping; resource.wrapT = THREE.RepeatWrapping; resource.colorSpace = THREE.NoColorSpace; resource.minFilter = THREE.LinearMipmapLinearFilter; resource.magFilter = THREE.LinearFilter; resource.generateMipmaps = true } ],
                [ 'zuoyizhuoRoadAsphalt',                  `zuoyizhuo/home/ground/asphalt_03/asphalt_03_diff_2k.jpg`,                         'texture', (resource) => { resource.wrapS = THREE.RepeatWrapping; resource.wrapT = THREE.RepeatWrapping; resource.colorSpace = THREE.SRGBColorSpace; resource.minFilter = THREE.LinearMipmapLinearFilter; resource.magFilter = THREE.LinearFilter; resource.generateMipmaps = true } ],
                [ 'zuoyizhuoStreetLamp',                   `zuoyizhuo/Prop_StreetLamp.glb`,                                                   'gltf' ],
                [ 'zuoyizhuoSignPost',                     `zuoyizhuo/Prop_Sign_Post.glb`,                                                    'gltf' ],
                [ 'zuoyizhuoBuildingTall',                 `zuoyizhuo/Building_Tower_Tall.glb`,                                               'gltf' ],
                [ 'zuoyizhuoBuildingNarrow',               `zuoyizhuo/Building_Tower_Narrow.glb`,                                             'gltf' ],
