...
export class ProjectsArea extends Area
{
    ...
    strip()
    {
        ...
        {
            for(const item of Object.values(this.attributes.items))
            {
                if(item?.group)
                    item.group.visible = false
            }
        ...
        if(this.pagination?.items)
        {
            ...
            if(this.pagination.previousIntersect)
                this.pagination.previousIntersect.active = false
            if(this.pagination.nextIntersect)
                this.pagination.nextIntersect.active = false
        }
        ...
        this.game.ticker.wait(15, () =>
        {
            if(this.images?.mesh)
                this.images.mesh.visible = false
        })
        this.game.ticker.wait(60, () =>
        {
            if(this.images?.mesh)
                this.images.mesh.visible = false
        })
